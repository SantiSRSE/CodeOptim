...
%   
% CAUTION: Output volume X has the dimensions already permuted.
% However, the origin and directions in the metadata are the original ones.
...
% Hack for ProcesaMRICardiaca. If the endian field is missing, use this
% computer endianness.
